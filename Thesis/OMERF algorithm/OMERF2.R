omerf= function (y, cov, group, xnam=NULL, interactions=NULL, quadratic=NULL, znam=NULL, bizero=NULL, 
                 itmax=100, toll=0.05) {
  ...
  library(ordinal)
  clm.formula=as.formula(paste("y ~ ", paste(xnam, collapse= "+"),"+",paste(interactions, collapse= "+"),"+",paste(quadratic, collapse= "+")))
